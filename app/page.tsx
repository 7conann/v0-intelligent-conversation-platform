      ...
      <div className="w-full max-w-md">
        <div className="border border-gray-800 rounded-2xl p-8 bg-gradient-to-b from-gray-900/50 to-gray-950/50 backdrop-blur">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white py-6 text-lg font-medium"
            >
              Entrar
            </Button>
          </form>

          <button className="w-full text-center text-purple-400 hover:text-purple-300 mt-6 text-sm">
            Esqueci minha senha
          </button>
        </div>
