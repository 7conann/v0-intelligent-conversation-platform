...
export default function WhitelabelLoginPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#050508]">
        <div className="text-center">
          ...
          <p className="text-blue-300">Verificando sessao...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 bg-[#050508] flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-md">
          {/* Logo */}
          <div className="flex justify-center mb-6 md:mb-8">
            <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center overflow-hidden">
              <Brain className="w-8 h-8 md:w-10 md:h-10 text-white" />
            </div>
          </div>

          {/* Title */}
          <h1 className="text-2xl md:text-4xl font-bold text-center mb-2 bg-gradient-to-r from-blue-400 via-blue-400 to-blue-500 bg-clip-text text-transparent">
            SUA MARCA AI
          </h1>
          ...
          {activeTab === "login" ? (
            <form onSubmit={handleLogin} className="space-y-4 md:space-y-5">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-white h-10 md:h-11 text-sm md:text-base font-medium cursor-pointer shadow-lg shadow-blue-500/20"
              >
      ...
      {/* Right Side - Branding */}
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-[#0a0a14] via-[#0d1525] to-[#050510] relative overflow-hidden items-center justify-center">
        ...
        <div className="absolute bottom-32 left-16 w-80 h-80 bg-blue-600 rounded-full blur-3xl opacity-15 animate-pulse delay-500" />
          ...
          <div className="bg-[#071209] border border-gray-800 rounded-2xl p-6 md:p-8 w-full max-w-md">
            ...
            <form onSubmit={handleForgotPassword} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <Button type="submit" disabled={isSendingResetEmail} className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-white h-11 cursor-pointer shadow-lg shadow-blue-500/20">
